...
public class CheckoutServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Order order = new Order(
            ...
            shippingAddress,
            paymentMethod,
            Boolean.parseBoolean(requestData.get("isGiftWrapped").toString()),
            (String) requestData.get("giftMessage"),
        ...
        double giftWrapFee = Boolean.parseBoolean(requestData.get("isGiftWrapped").toString()) ? 5.00 : 0.00;
        double total = subtotal + tax + shipping + giftWrapFee;
