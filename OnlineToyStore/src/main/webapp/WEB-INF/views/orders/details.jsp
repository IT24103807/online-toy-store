...
<body>
    ...
    <script>
        ...
        function refreshOrderStatus() {
            fetch('${pageContext.request.contextPath}/orders/${order.id}')
                ...
                .then(html => {
                    ...
                    // Find the status badge in the response
                    const newStatusBadge = tempDiv.querySelector('.card-header .badge');
                    if (newStatusBadge) {
                        // Replace the current status badge with the new one
                        const currentStatusBadge = document.querySelector('.card-header .badge');
