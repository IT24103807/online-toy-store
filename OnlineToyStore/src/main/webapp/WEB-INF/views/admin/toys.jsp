...
<body>
                                        ...
                                        <tr data-toy-id="${toy.id}">
                                            ...
                                            <td>
                                                <button class="btn btn-sm btn-primary" 
                                                        onclick="editToy('${toy.id}', '${toy.name}', '${toy.description}', '${toy.brand}', '${toy.category}', '${toy.price}', '${toy.stockQuantity}', '${toy.imageUrl}', '${toy.active}')">
    ...
    <script>
        ...
        function editToy(toyId, name, description, brand, category, price, stockQuantity, imageUrl, isActive) {
